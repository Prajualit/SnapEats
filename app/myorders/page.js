        ...
        <>
            <div className='bg-[#0f0e19] font-[900] w-full min-h-screen text-[#FEE69A] flex justify-start pt-8 items-center flex-col space-y-8'>
                ...
                <div className='w-full flex flex-col items-center' >
                    {Array(orderData) == [] && <div className='text-[48px]'>
                        My Orders
                    </div>
                    }
                            ...
                            {orderData != {} ? Array(orderData).map(data => {
                                return (
                                    data.orderData ?
                                                    ...
                                                    return (
                                                        <div key={index} className='flex items-center justify-center space-y-3 w-full'>
                                                            {arrayData.Order_date ?
                                                                ...
                                                                <>
                                                                    <div key={arrayData._id} className='border-[#1c233b] border-[1px] w-[350px] rounded-xl flex flex-col items-start bg-[#0f0e19]'>
                                                                        <Image className='rounded-t-xl h-[55%]' width={350} height={350} src={arrayData.img} alt="" />
                                        ...
                                        }) : <div className=' text-[48px] flex items-center justify-center h-[80vh]'>No Orders!</div>
                                )
                            }) : ""}
                        </tbody>
                    </table>
